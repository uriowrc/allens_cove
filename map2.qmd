...
x <- mapview(watershed_boundary_ln, color = "black", alpha.regions = 0.2,map.types = c("OpenStreetMap.Mapnik", "Esri.WorldImagery"), legend = FALSE, lwd = 2, label = NA) + mapview(e911, cex = 3, zcol = "address", legend = FALSE, col.regions = "darkblue")
